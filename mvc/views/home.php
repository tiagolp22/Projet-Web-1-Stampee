{{ include('layouts/header.php', {title: 'Stampee'}) }}
    ...
    <main class="main-index">
        ...
        <div class="index-hero__carroussel">
          <div class="index-hero-photo">
            ...
            <div class="index-hero-photo-g">
              <img
                class="hero-photo"
                src="./public./assets/img/timbres/timbreCA.webp"
                loading="lazy"
          ...
          <div class="encheres-jour_vedettes">
            <div class="vedette-p">
              <img
                class="vedette-photo"
                src="./public/assets/img/timbres/timbre1.webp"
                loading="lazy"
            ...
            <div class="vedette-p">
              <img
                class="vedette-photo"
                src="./public/assets/img/timbres/timbre2.webp"
                loading="lazy"
                alt="image du timbre aux enchères du jour"
              />
            </div>
            <div class="vedette-p">
              <img
                class="vedette-photo"
                src="./public/assets/img/timbres/timbre3.webp"
                loading="lazy"
                alt="image du timbre aux enchères du jour"
              />
            </div>
      ...
      <section class="index-services">
        <div class="index-services_icones">
          <img
            src="./public/assets/img/icons/collection.svg"
        ...
        <div class="index-services_icones">
          <img
            src="./public/assets/img/icons/evaluation.svg"
            class="index-services_svg"
        ...
        <div class="index-services_icones">
          <img
            src="./public/assets/img/icons/worldstamp.svg"
            class="index-services_svg"
          ...
          <div class="index-encheres_gallerie__photos">
            ...
            <div class="timbre-index-photo">
              <div class="photo-index-produit">
                <h3>Les Animaux</h3>
                <img
                  src="./public/assets/img/timbres/timbre6.webp"
