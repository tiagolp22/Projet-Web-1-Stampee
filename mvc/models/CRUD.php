...
abstract class CRUD extends \PDO
{
    ...
    public function unique($field, $value)
    {
      ...
      public function updateOffert($prix_min, $id)
    {
        $sql = "UPDATE stampee_enchere SET prix_min = $prix_min WHERE id = $id;";
    ...
    public function selectUserIndex($value)
    {
        $sql = " SELECT  stampee_favoris.*, stampee_timbre.timbre_nom,stampee_timbre.tirage,stampee_timbre.pays_origine,stampee_timbre.date_creation,stampee_timbre.id as id_timbre FROM stampee_favoris
                inner join stampee_enchere on id_enchere = stampee_enchere.id
                inner join stampee_timbre on stampee_timbre.id = stampee_enchere.id_timbre
                WHERE stampee_favoris.id_user = $value;";                
