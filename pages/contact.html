  ...
  <body class="body-index">
    <header class="header-top">
      <div class="header-top__superieur">
        <div class="header-top__logo">
          <a href="../index.html"
            ><img
              src="../assets/img/logos/Stampee_logo_titre.png"
              alt="logo Stampee"
    ...
    <main class="main-contact">
      <div class="form-form-contact">
        ...
        <p>
          Notre équipe est à votre disposition pour répondre à vos questions, à
          vos demandes de services et à vos suggestions.
        </p>
        <form class="form-contact">
          <label for="name">Votre nom</label>
          <input type="text" name="nom" id="name" class="form-contact_input" />

          <label for="email">Votre e-mail</label>
          <input type="email" name="email" id="email" class="form-contact_input" />

          <label for="sujet"> Sujet </label>
          <input type="text" name="sujet" id="sujet" class="form-contact_input" />

          <label for="message">Votre message</label>
          <textarea name="message" id="message" class="form-contact_textarea"></textarea>
    ...
    <footer class="footer">
      <div class="footer__content--all">
        <div class="footer__content">
          <div class="footer_left-side">
            ...
            <section class="footer__contact">
              <p>LORD STAMPEE INC.1988</p>
              <p>Maisonneuve HHH-222</p>
              <p>Tel: 020 2020-0202</p>
              <p>Email: stampee@tampee.com</p>
            </section>
          </div>
          <img
            class="footer__logo"
        ...
        <p class="footer_droits-auteur">© 1950-2024, stampee.com, inc</p>
      </div>
    </footer>
  </body>
</html>
